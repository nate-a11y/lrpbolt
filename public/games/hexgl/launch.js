...
(function() {
  ...
  var launchOverlay = $('lrp-launch');
  if (launchOverlay) {
    var hideOverlay = function() {
      launchOverlay.classList.add('lrp-launch--hidden');
      window.removeEventListener('keydown', hideOverlay);
      window.removeEventListener('pointerdown', hideOverlay);
