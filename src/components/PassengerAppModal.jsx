      ...
      content: (
        <>
          ...
          <Box component="ul" sx={{ pl: 3, mb: 1 }}>
            <li><Typography variant="body2">Trip type</Typography></li>
            <li><Typography variant="body2">Order type</Typography></li>
            <li><Typography variant="body2">Date and time</Typography></li>
            <li><Typography variant="body2">Pickup & drop-off</Typography></li>
            <li><Typography variant="body2">Passenger count</Typography></li>
          </Box>
    ...
    <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
      ...
      <DialogContent dividers>
        <Typography variant="body2" sx={{ mb: 2 }}>
          Booking a ride with the Passenger App is easy, quick, and personalized to your needs. Here’s how to make the most of it:
        </Typography>
