...
export const NAV_ITEMS = [
  ...
  { to: "/vehicle-calendar",label: "Ride & Vehicle Calendar", icon: "EventAvailable" },
  { to: "/scan",            label: "Ticket Scanner",        icon: "CropFree" },
  { to: "/tickets",         label: "Tickets",               icon: "ConfirmationNumber" },
  { to: "/admin-time-log",  label: "Admin Logs",            icon: "AdminPanelSettings", admin: true },
  { to: "/admin-user-manager", label: "User Manager",       icon: "ManageAccounts", admin: true },
  { to: "/ride-entry",      label: "Add Ride",              icon: "AddCircleOutline", admin: true },
  { to: "/generate-ticket", label: "Generate Ticket",       icon: "AppShortcut", admin: true },
];
